...
module JiraRestApi
  module Resource
    ...
    class IssueFactory < JiraRestApi::BaseFactory # :nodoc:
    end

    class Issue < JiraRestApi::Base

      has_one :reporter,  :class => JiraRestApi::Resource::User,
                          :nested_under => 'fields'
      has_one :assignee,  :class => JiraRestApi::Resource::User,
                          :nested_under => 'fields'
