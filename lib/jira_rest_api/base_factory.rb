module JiraRestApi
  ...
  # This is the base class for all the JiraRestApi resource factory instances.
  class BaseFactory
    ...
    # JiraRestApi::Resource::FooFactory creates JiraRestApi::Resource::Foo instances.
    def target_class
      # Need to do a little bit of work here as Module.const_get doesn't work
      # with nested class names, i.e. JiraRestApi::Resource::Foo.
      #
      # So create a method chain from the class componenets.  This code will
      # unroll to:
      #   Module.const_get('JiraRestApi').const_get('Resource').const_get('Foo')
      #
