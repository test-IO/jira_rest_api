...
describe JiraRestApi::HttpClient do

  let(:basic_client) do
    options = JiraRestApi::Client::DEFAULT_OPTIONS.merge(JiraRestApi::HttpClient::DEFAULT_OPTIONS)
    JiraRestApi::HttpClient.new(options)
  end
