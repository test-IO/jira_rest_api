...
describe JiraRestApi::Resource::Project do
  ...
  describe "relationships" do
    subject {
      JiraRestApi::Resource::Project.new(client, :attrs => {
          'lead'        => {'foo' => 'bar'},
    ...
    it "has the correct relationships" do
      subject.should have_one(:lead, JiraRestApi::Resource::User)
      subject.lead.foo.should == 'bar'

      subject.should have_many(:issuetypes, JiraRestApi::Resource::Issuetype)
