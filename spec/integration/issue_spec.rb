...
describe JiraRestApi::Resource::Issue do
  ...
  with_each_client do |site_url, client|
    ...
    describe "GET all issues" do # JiraRestApi::Resource::Issue.all uses the search endpoint
      let(:client) { client }
      let(:site_url) { site_url }
    ...
    describe "GET jql issues" do # JiraRestApi::Resource::Issue.jql uses the search endpoint
